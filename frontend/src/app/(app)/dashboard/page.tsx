  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="px-6 py-5 border-b border-[#E2E8F0] bg-white">
        <h1 className="text-xl font-bold text-[#0F172A]">Tax Season {CURRENT_FILING_YEAR}</h1>
        {!questionnaire && (
          <div className="mt-3 p-3.5 bg-amber-50 border border-amber-200 rounded-xl text-sm">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-0 overflow-hidden">
        {/* Left: Task board */}
        <div className="overflow-y-auto p-6 border-r border-[#E2E8F0]">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link
              href="/profile"
              className="text-xs text-[#2F8AE5] font-medium hover:underline"
            >
              Edit profile
            </Link>
          </div>
        ...
        <div className="overflow-y-auto p-6 bg-[#F8FAFC]">
          <h2 className="text-sm font-semibold text-[#0F172A] mb-4 tracking-tight">
            Upcoming Forms
          </h2>
          <FormsChecklist
          ...
          {checklist && checklist.length === 0 && questionnaire && (
            <p className="text-xs text-[#64748B] mt-4">
              ...
              <Link href="/profile" className="text-[#2F8AE5] font-medium hover:underline">
                Update your profile
              </Link>{" "}
